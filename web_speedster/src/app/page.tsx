  ...
  return (
    <div className="font-inter min-h-screen">
      ...
      <div className="p-8 bg-white text-black">
        ...
        <div className="flex flex-col grid-cols-3 justify-evenly md:flex-row mb-96 md:mb-8">
          <Blog
          ...
          <Blog
            image="/assets/blog-images/blog2.jpg" 
          ...
          <Blog
            image="/assets/blog-images/blog3.jpg" 
          ...
          <Blog
            image="/assets/blog-images/blog4.jpg" 
